...
/**
 * Debug API Response Helper Script
 * 
 * Simple script to manually test API responses from localhost:3000/api/lookup
 * Useful for debugging 500 errors and understanding API behavior
 * 
 * Usage:
 *   npx tsx scripts/debug-api-response.ts Lipton "Lipton Tea"
 *   npx tsx scripts/debug-api-response.ts Samsung "Samsung Galaxy"
 *   npx tsx scripts/debug-api-response.ts UnknownBrand "Unknown Product"
 */
...
async function debugApiRequest(options: DebugOptions) {
  ...
  console.log('🔍 DEBUG API RESPONSE HELPER');
  console.log('============================');
...
if (args.length < 2) {
  console.log('Usage: npx tsx scripts/debug-api-response.ts <brand> <product> [url] [timeout] [verbose]');
  console.log('');
  console.log('Examples:');
  console.log('  npx tsx scripts/debug-api-response.ts Lipton "Lipton Tea"');
  console.log('  npx tsx scripts/debug-api-response.ts Samsung "Samsung Galaxy"');
  console.log('  npx tsx scripts/debug-api-response.ts UnknownBrand "Unknown Product"');
  console.log('  npx tsx scripts/debug-api-response.ts Lipton "Lipton Tea" http://localhost:3000/api/lookup 30000 true');
  process.exit(1);
}
