...
export default function FeedbackModal({ result, onClose, onSubmit }: FeedbackModalProps) {
  ...
  // If no result is provided, don't render the modal
  if (!result) {
    return null
  }
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="flex items-center">
                ...
                Flag Result - {result.brand || 'Unknown'}
              </CardTitle>
            ...
            <div className="text-sm text-gray-600">
              Product: {result.product_name || 'N/A'} | Confidence: {result.confidence_score?.toFixed(1) || 0}%
            </div>
          </CardHeader>
