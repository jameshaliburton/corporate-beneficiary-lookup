...
export const MoreDetails = ({ 
  ...
  if (!country && !ownershipType && !parentCompany && !stockTicker && !yearFounded && !ownershipPercentage && !confidenceScore) {
    return null;
  }
    ...
    <Card className="rounded-2xl shadow-sm">
      ...
      {isExpanded && (
        <CardContent className="space-y-4 pt-0">
          ...
          {ownershipPercentage && (
            <div className="flex items-center gap-3">
              <span className="text-sm font-medium text-muted-foreground">Ownership Percentage:</span>
